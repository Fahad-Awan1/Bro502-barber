...
const variants: Record<Variant, string> = {
  gold: "bg-espresso text-primary-foreground shadow-[var(--shadow-soft)] hover:bg-gold hover:text-accent-foreground hover:shadow-[var(--shadow-lift)]",
  outline:
    "border border-gold/60 bg-transparent text-foreground hover:border-gold hover:bg-gold/10",
