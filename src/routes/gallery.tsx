...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery | Cuts, Shaves & Styling at Bro 502 Barber Seattle" },
      {
        name: "description",
        content:
          "Browse fades, beard sculpts, hot towel shaves and styling work from the chairs at Bro 502 Barber in Seattle.",
      },
      { property: "og:title", content: "Gallery | Bro 502 Barber Seattle" },
      {
        property: "og:description",
        content: "Fades, beard sculpts and hot towel shaves from the Bro 502 Barber chairs.",
      },
    ],
  }),
