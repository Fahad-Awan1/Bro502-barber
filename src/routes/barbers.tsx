...
import { BARBERS, type Barber } from "@/lib/site-data";
import { motion, useReducedMotion } from "framer-motion";

export const Route = createFileRoute("/barbers")({
  head: () => ({
    meta: [
      { title: "Our Barbers | Meet the Bro 502 Barber Team in Seattle" },
      {
        name: "description",
        content:
          "Meet the four barbers behind Bro 502 Barber in Seattle — specialists in skin fades, textured crops, grey blending and straight razor shaves.",
      },
      { property: "og:title", content: "Our Barbers | Bro 502 Barber Seattle" },
      {
