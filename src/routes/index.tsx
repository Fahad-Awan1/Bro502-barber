...
import { SERVICES, HOURS, BUSINESS } from "@/lib/site-data";
import interior1 from "@/assets/interior-1.jpg";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Bro502 Barbershop | Premium Grooming Lounge in Honolulu" },
      {
        name: "description",
        content:
          "A premium barbershop on Kona Street, Honolulu. Signature cuts, beard sculpting and hot towel shaves — book your chair at Bro502.",
      },
      { property: "og:title", content: "Bro502 Barbershop | Premium Grooming in Honolulu" },
      {
        property: "og:description",
        content: "Precision cuts, beard sculpting and hot towel shaves on Kona Street, Honolulu.",
      },
    ],
  }),
  component: Index,
    ...
    <>
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 md:grid-cols-2 md:px-8">
          <Reveal x={-30} y={0}>
            <p className="eyebrow">Welcome to Bro502</p>
            ...
            <p className="mt-6 text-base leading-relaxed text-muted-foreground">
              We opened Bro502 with one idea: a man's haircut should feel like an appointment worth
              keeping. Marble, warm linen and brass — a quiet room where the coffee is good and the
              barber never rushes.
            </p>
          ...
          <Reveal x={30} y={0} delay={0.1}>
            <div className="relative">
              <div className="absolute -top-4 -right-4 hidden h-full w-full border border-gold/40 sm:block" aria-hidden="true" />
              <img
                src={interior1}
      ...
      <section className="surface-linen border-y border-border py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <ul className="mt-14 grid gap-6 md:grid-cols-3">
            {HIGHLIGHTS.map((h, i) => (
              <Reveal as="li" key={h.title} delay={i * 0.1} className="lux-card lux-card-hover p-8">
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <ul className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {SERVICES.slice(0, 3).map((s, i) => (
              <Reveal as="li" key={s.id} delay={i * 0.08} className="lux-card lux-card-hover p-8">
          ...
          <Reveal delay={0.2} className="mt-12 text-center">
            <Link to="/services" className="inline-flex items-center gap-2 text-sm text-gold hover:underline">
      ...
      <section className="surface-linen border-y border-border py-24 md:py-32">
        <div className="mx-auto grid max-w-7xl gap-14 px-5 md:grid-cols-2 md:px-8">
          <Reveal>
            ...
            <h2 className="mt-4 font-serif text-3xl sm:text-4xl">Open seven days</h2>
          ...
          <Reveal delay={0.1} className="flex flex-col justify-center">
            ...
            <h2 className="mt-4 font-serif text-3xl leading-tight sm:text-4xl">
              Reserve your chair on Kona Street
            </h2>
